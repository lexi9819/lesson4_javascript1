        ...
        *************************************************************************************************/
         ...
         function calculatePercentages() {
                  ...
                  **************************************************************************************************/
                  ...
                  var householdAmt = document.getElementById("household").value;
                  var miscellaneousAmt = document.getElementById("miscellaneous").value;
                  var transportationAmt = document.getElementById("travel");
                  ...
                  *******************************************************************************************************/  
                  ...
                  document.getElementById("transportationPercentage").innerHTML = "% for <b> transportation:</b>       " +householdPct.toFixed(1);
                  document.getElementById("miscellaneousPercentage").innerHTML = "% for <b> miscellaneous:</b>       " +householdPct.toFixed(1);
